...
|---|---|---|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **Baca Camargo, Vitaly Arturo**<br>**AV1:** Diagram DataBase y Diagram Class; Definición de Bounded Context y EventStorming; Deployment Landing Page.<br>**TB1:** Login, Register y Menú Principal; Creación de Proyectos (feature).<br>**AV2:** Backend Deployment; Swagger/OpenAPI Documentation; Arquitectura Backend basada en Domain-Driven Design.<br>**TB2:** Refinamiento de Tasks Back & CQRS (Sustentó las mejoras aplicadas en los comandos de transición de estado) e Integración Frontend Base (Expuso la consolidación de las vistas principales del cliente web).<br><br>**Bautista Rivera, Jose Diego**<br>**AV1:** Chapter 4 - Style Guidelines; Chapter 5 - Software Configuration Management y Sprint 1; Landing Page Mock-up Mobile Responsive.<br>**TB1:** Diseño UI del frontend y sustentación de criterios estéticos.<br>**AV2:** Profile Frontend Module e Integración Frontend con servicios de gestión de perfiles.<br>**TB2:** Milestones Bounded Context (Sustentó la implementación del ciclo de vida de los hitos en el backend y la refactorización integral hacia UUIDs) y UI Timeline de Hitos (Demostró el comportamiento interactivo del componente de línea de tiempo integrado en el frontend).<br><br>**Pariachi Limahuaya, Sebastián Ubaldo**<br>**AV1:** Impact Mapping; User Stories; Product Backlog.<br>**TB1:** Responsive Design y comunicación de criterios de adaptabilidad en la interfaz.<br>**AV2:** Comments Bounded Context y REST API Validation.<br>**TB2:** Messaging Bounded Context (Expuso la arquitectura técnica implementada para el canal de chat, detallando el flujo de mensajería asíncrona mediante WebSockets con protocolo STOMP).<br><br>**Teran Zavala, Mauricio Alejandro**<br>**AV1:** Landing Page mock-up y Landing Page implementation.<br>**TB1:** Sprint Planning 2 (Lideró la exposición oral del plan del sprint, objetivos y distribución de tareas).<br>**AV2:** IAM Users Bounded Context y Sprint Planning 3.<br>**TB2:** Infraestructura y Shared Context (Sustentó la consistencia del dominio compartido del backend, la optimización de variables de entorno y el estado del despliegue en producción a través de Railway).<br><br>**Almandroz Carbajal, Pierina Marysabel**<br>**AV2:** Tasks Frontend Module y Applications Frontend Module.<br>**TB2:** Applications Bounded Context (Expuso el diseño táctico del agregado y los endpoints de postulación) y Kanban Render (Presentó la validación visual del renderizado dinámico de tareas en el tablero del frontend).<br><br>**Taipe Sangama, Jorge Francisco**<br>**AV2:** Profiles Bounded Context y REST Services Validation.<br>**TB2:** Configuración e Internacionalización (Explicó el despliegue del API, el soporte multiidioma en los mensajes de validación y los resultados de las evaluaciones heurísticas de experiencia de usuario). | El grupo demostró capacidad de comunicación oral efectiva al exponer los avances del proyecto ante diferentes audiencias, incluyendo docentes y compañeros. Durante el AV1, cada integrante presentó sus contribuciones de forma clara y estructurada, adaptando el nivel técnico del discurso según el contexto. En el TB1, esta competencia se fortaleció al sustentar decisiones de desarrollo frontend, diseño y planificación ágil, evidenciando mayor dominio técnico y fluidez expositiva. Durante el AV2, el equipo consolidó estas habilidades mediante la exposición de la arquitectura backend basada en Domain-Driven Design, la implementación de bounded contexts, el desarrollo de servicios REST, la documentación Swagger/OpenAPI, la validación de funcionalidades frontend y el despliegue del Backend Web Service utilizando Docker, Railway y MySQL. Finalmente, en la **TB2**, el equipo alcanzó la excelencia comunicativa al sustentar con solvencia la integración total de la plataforma, defendiendo técnicamente la asincronía de mensajería en tiempo real mediante WebSockets, las reglas tácticas del dominio para postulaciones e hitos, y la mitigación final de la deuda técnica frente a los objetivos del MVP. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | **Baca Camargo, Vitaly Arturo**<br>**AV1:** Diagram DataBase y Diagram Class; Definición de Bounded Context y EventStorming; Deployment Landing Page.<br>**TB1:** Login, Register y Menú Principal; Creación de Proyectos (feature).<br>**AV2:** Backend Deployment Documentation; Swagger/OpenAPI Documentation; Arquitectura Backend basada en Domain-Driven Design y documentación de bounded contexts.<br>**TB2:** Planificación del Sprint 4 (Estructuró de forma escrita el Sprint Planning 4, desglosando minuciosamente el backlog en sub-tareas de ingeniería con métricas de estimación precisas).<br><br>**Bautista Rivera, Jose Diego**<br>**AV1:** Chapter 4 - Style Guidelines; Chapter 5 - Software Configuration Management y Sprint 1; Landing Page Mock-up Mobile Responsive.<br>**TB1:** Diseño UI del frontend y documentación de decisiones visuales.<br>**AV2:** Documentación del módulo Profile Frontend; evidencias de integración frontend y validación funcional.<br>**TB2:** Documentación BC Milestones (Documentó la especificación técnica de la gestión de hitos, cubriendo los diagramas de transición y la actualización de contratos en Swagger/OpenAPI).<br><br>**Pariachi Limahuaya, Sebastián Ubaldo**<br>**AV1:** Impact Mapping; User Stories; Product Backlog.<br>**TB1:** Responsive Design y documentación de criterios de adaptabilidad.<br>**AV2:** Documentación del bounded context Comments; especificación de endpoints REST y evidencias de integración backend.<br>**TB2:** Documentación BC Messaging (Redactó el diseño del nuevo módulo de chat, especificando el flujo de WebSockets y la capa de anticorrupción ACL para acoplarlo de forma segura con IAM).<br><br>**Teran Zavala, Mauricio Alejandro**<br>**AV1:** Landing Page mock-up; Landing Page implementation.<br>**TB1:** Sprint Planning 2 y documentación de objetivos, backlog y criterios de aceptación.<br>**AV2:** Documentación del bounded context IAM Users; Sprint Planning 3; evidencias de desarrollo backend y seguimiento de actividades.<br>**TB2:** Infraestructura y Configuración (Redactó la documentación del Shared Context, políticas CORS y las guías de aprovisionamiento en Railway con base de datos MySQL).<br><br>**Almandroz Carbajal, Pierina Marysabel**<br>**AV2:** Documentación de los módulos Tasks y Applications del Frontend Web Application; evidencias de validación funcional y descripción de componentes.<br>**TB2:** Documentación BC Applications (Elaboró las secciones técnicas detallando la lógica de agregados, contratos de servicios REST y las evidencias de validación de postulaciones).<br><br>**Taipe Sangama, Jorge Francisco**<br>**AV2:** Documentación del bounded context Profiles; especificación de servicios REST; evidencias de persistencia y repositorios.<br>**TB2:** Internacionalización y OpenAPI (Documentó e indexó la configuración de internacionalización en/es, el diccionario de mensajes de error del sistema y la actualización completa de Swagger). | A lo largo del AV1 y TB1, el grupo elaboró documentación técnica y visual de calidad. En el AV1 se sentaron las bases documentales del proyecto mediante la elaboración de diagramas, User Stories, Product Backlog, Style Guidelines y evidencias de implementación. En el TB1 esta competencia se fortaleció mediante la documentación del desarrollo frontend, planificación ágil, diseño responsivo y evidencias funcionales. Durante el AV2, el equipo consolidó sus habilidades de comunicación escrita mediante la elaboración de documentación técnica de la arquitectura backend basada en Domain-Driven Design, bounded contexts, servicios REST, documentación Swagger/OpenAPI, despliegue del Backend Web Service y validación de funcionalidades frontend y backend. Finalmente, en la **TB2**, la competencia escrita alcanzó su nivel de consolidación más alto mediante la entrega de un informe final exhaustivo que unifica todos los Bounded Contexts del backend, detalla la especificación OpenAPI de los nuevos módulos finales (Applications, Milestones, Messaging) e indexa rigurosamente los reportes de usabilidad heurística y validación de usuarios, asegurando claridad, organización y precisión para audiencias técnicas y no técnicas. |
