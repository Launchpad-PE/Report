...
- [5.2. Landing Page, Services & Applications Implementation](05-Chapter-5-Product-Implementation%2C-Validation-%26-Deployment.md#52-landing-page-services--applications-implementation)
  ...
  - [5.2.3. Sprint 3](05-Chapter-5-Product-Implementation,-Validation-&-Deployment.md#523-sprint-2)
    - [5.2.3.1. Sprint Planning 3](05-Chapter-5-Product-Implementation,-Validation-&-Deployment.md#5231-sprint-planning-2)
    ...
    - [5.2.3.3. Sprint Backlog 3](05-Chapter-5-Product-Implementation,-Validation-&-Deployment.md#5233-sprint-backlog-2)
...
|---|---|---|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | Baca Camargo, Vitaly Arturo<br>AV1<br>Diagram DataBase y Diagram Class: Desarrolló habilidades de modelado de datos para representar la arquitectura del sistema de forma estructurada.<br>Definición de Bounded Context y EventStorming: Aplicó técnicas de diseño orientado al dominio para delimitar responsabilidades del sistema.<br>Deployment Landing Page: Adquirió competencias de despliegue web para poner en producción la página del proyecto.<br>**AV2**<br>Login, Register y Menú Principal: Expuso de forma clara el flujo de autenticación y navegación implementado en Angular, comunicando decisiones técnicas ante el equipo y docentes.<br>Creación de Proyectos (feature): Presentó oralmente el funcionamiento del módulo, explicando la lógica de componentes y la conexión con JSON Server.<br><br>Bautista Rivera, Jose Diego<br>AV1<br>Chapter 4 - Style Guidelines: Aprendió a definir y documentar estándares visuales y de diseño para el equipo.<br>Chapter 5 - Software Configuration Management y Sprint 1: Aplicó metodologías de gestión de configuración y planificación ágil.<br>Landing Page Mock-up Mobile Responsive: Desarrolló habilidades de diseño adaptable para distintos dispositivos.<br>**AV2**<br>Diseño UI del frontend: Comunicó oralmente las decisiones de diseño visual adoptadas para las vistas desarrolladas en Angular, sustentando criterios estéticos y de usabilidad ante distintas audiencias.<br><br>Pariachi Limahuaya, Sebastián Ubaldo<br>AV1<br>Impact Mapping: Aplicó técnicas de alineación estratégica entre objetivos del negocio y funcionalidades del producto.<br>User Stories: Adquirió habilidades para traducir necesidades del usuario en requerimientos funcionales claros.<br>Product Backlog: Desarrolló competencias de priorización y gestión de tareas en entornos ágiles.<br>**AV2**<br>Responsive Design: Expuso los criterios de adaptabilidad aplicados en la interfaz, comunicando de forma efectiva las decisiones de diseño responsivo a compañeros y docentes.<br><br>Teran Zavala, Mauricio Alejandro<br>AV1<br>Landing Page mock-up: Aplicó principios de diseño UI/UX para estructurar visualmente la propuesta del producto.<br>Landing Page implementation: Adquirió habilidades de desarrollo frontend para llevar el diseño a código funcional.<br>**AV2**<br>Sprint Planning 2: Lideró la exposición oral del plan del sprint, comunicando objetivos, distribución de tareas y criterios de aceptación de forma estructurada ante el equipo y evaluadores. | El grupo demostró capacidad de comunicación oral efectiva al exponer los avances del proyecto ante diferentes audiencias, incluyendo docentes y compañeros. Durante el AV1, cada integrante presentó sus contribuciones de forma clara y estructurada, adaptando el nivel técnico del discurso según el contexto. En el AV2, esta competencia se fortaleció al sustentar decisiones de desarrollo frontend, diseño y planificación ágil, evidenciando mayor dominio técnico y fluidez expositiva. |
| **Comunica por escrito con efectividad a diferentes rangos de audiencia.** | Baca Camargo, Vitaly Arturo<br>AV1<br>Diagram DataBase y Diagram Class: Desarrolló habilidades de modelado de datos para representar la arquitectura del sistema de forma estructurada.<br>Definición de Bounded Context y EventStorming: Aplicó técnicas de diseño orientado al dominio para delimitar responsabilidades del sistema.<br>Deployment Landing Page: Adquirió competencias de despliegue web para poner en producción la página del proyecto.<br>**AV2**<br>Login, Register y Menú Principal: Documentó por escrito la implementación de los componentes de autenticación y navegación, detallando la estructura de las vistas y los servicios HTTP utilizados con JSON Server.<br>Creación de Proyectos (feature): Redactó la evidencia de desarrollo del módulo, describiendo el flujo de datos entre componentes Angular y la API simulada.<br><br>Bautista Rivera, Jose Diego<br>AV1<br>Chapter 4 - Style Guidelines: Aprendió a definir y documentar estándares visuales y de diseño para el equipo.<br>Chapter 5 - Software Configuration Management y Sprint 1: Aplicó metodologías de gestión de configuración y planificación ágil.<br>Landing Page Mock-up Mobile Responsive: Desarrolló habilidades de diseño adaptable para distintos dispositivos.<br>**AV2**<br>Diseño UI del frontend: Documentó por escrito las decisiones de diseño visual de las vistas de la aplicación, elaborando guías y evidencias escritas que comunican los criterios estéticos y de experiencia de usuario aplicados.<br><br>Pariachi Limahuaya, Sebastián Ubaldo<br>AV1<br>Impact Mapping: Aplicó técnicas de alineación estratégica entre objetivos del negocio y funcionalidades del producto.<br>User Stories: Adquirió habilidades para traducir necesidades del usuario en requerimientos funcionales claros.<br>Product Backlog: Desarrolló competencias de priorización y gestión de tareas en entornos ágiles.<br>**AV2**<br>Responsive Design: Documentó por escrito la implementación del diseño adaptable, describiendo los breakpoints y criterios aplicados para garantizar una experiencia consistente en distintos dispositivos.<br><br>Teran Zavala, Mauricio Alejandro<br>AV1<br>Landing Page mock-up: Aplicó principios de diseño UI/UX para estructurar visualmente la propuesta del producto.<br>Landing Page implementation: Adquirió habilidades de desarrollo frontend para llevar el diseño a código funcional.<br>**AV2**<br>Sprint Planning 2: Elaboró y documentó por escrito el plan del sprint, incluyendo objetivos, Sprint Backlog y criterios de aceptación, comunicando de forma clara y estructurada los compromisos del equipo para esta entrega. | A lo largo del AV1 y AV2, el grupo elaboró documentación técnica y visual de calidad. En el AV2 esta competencia se consolidó mediante la redacción de evidencias de desarrollo frontend, documentación de servicios HTTP, diseño responsivo y planificación del sprint. Los entregables escritos demuestran capacidad para comunicar con precisión tanto a audiencias técnicas como no técnicas, manteniendo un lenguaje claro, organizado y alineado a los estándares del curso. |
